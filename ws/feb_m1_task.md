...
31. Ваша работа должна быть доступна по адресу: `https://std${std_num}.gramend.ru/ws/feb/module1/`,
32. где ${std_num} – ваш номер по списку
...
директории `/home/std${std_num}/feb/module1/`.
